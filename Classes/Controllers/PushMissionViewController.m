...
- (void)viewDidLoad {
    ...
    tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, zNavigationHeight, zScreenWidth, zScreenHeight-49-zNavigationHeight) style:UITableViewStyleGrouped];
