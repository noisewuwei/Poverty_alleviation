...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"information_unselected"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"information_selected"] forState:UIControlStateSelected];
