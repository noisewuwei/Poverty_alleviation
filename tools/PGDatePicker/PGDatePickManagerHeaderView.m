...
- (void)setupButton {
    ...
    [self.cancelButton setTitleColor:[UIColor colorWithHexString:@"#1055e8"] forState:UIControlStateNormal];
    ...
    [self.confirmButton setTitleColor:[UIColor colorWithHexString:@"#1055e8"] forState:UIControlStateNormal];
