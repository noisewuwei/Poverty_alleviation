...
- (UIColor *)lineBackgroundColor {
    if (!_lineBackgroundColor) {
        _lineBackgroundColor = [UIColor colorWithHexString:@"#979797"];
    }
...
- (UIColor *)textColorOfSelectedRow {
    if (!_textColorOfSelectedRow) {
        _textColorOfSelectedRow = [UIColor colorWithHexString:@"#2f2f2f"];
    }
...
- (UIColor *)middleTextColor {
    if (!_middleTextColor) {
        _middleTextColor = [UIColor colorWithHexString:@"#2f2f2f"];
    }
